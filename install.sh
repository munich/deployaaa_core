...
git clone "git@github.com:munich/deployaaa_core.git" "/home/bridgechain/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'git@github.com:munich/deployaaa_core.git'"
